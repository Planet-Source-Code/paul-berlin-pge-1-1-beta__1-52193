...
'**** Below ADDED for clsFmod *****

Public Enum enumInitOutput
  Out_Autodetect = 0
  Out_DirectSound = 1
  Out_WinMM = 2
End Enum

Public Enum enumInitMixer
  Mix_Autodetect = 0
  Mix_CPU_FPU_32 = 1
  Mix_MMX_P5_16 = 2
  Mix_MMX_P6_16 = 3
...
'**** Above ADDED for clsFmod *****

Public Const FMOD_VERSION = 3.62
...
Public Declare Function FSOUND_Stream_OpenFile2 Lib "fmod.dll" Alias "_FSOUND_Stream_OpenFile@12" (ByVal filename As Long, ByVal mode As FSOUND_MODES, ByVal memlength As Long) As Long
Public Declare Function FSOUND_Stream_Open2 Lib "fmod.dll" Alias "_FSOUND_Stream_OpenFile@12" (ByRef data As Byte, ByVal mode As FSOUND_MODES, ByVal memlength As Long) As Long
...
Public Declare Function FSOUND_Stream_AddSynchPoint Lib "fmod.dll" Alias "_FSOUND_Stream_AddSynchPoint@12" (ByVal stream As Long, ByVal pcmoffset As Long, ByVal userdata As Long) As Long
Public Declare Function FSOUND_Stream_DeleteSynchPoint Lib "fmod.dll" Alias "_FSOUND_Stream_DeleteSynchPoint@8" (ByVal stream As Long, ByVal index As Long) As Byte
Public Declare Function FSOUND_Stream_GetNumSynchPoints Lib "fmod.dll" Alias "_FSOUND_Stream_GetNumSynchPoints@4" (ByVal stream As Long) As Long
...
Public Declare Function FMUSIC_LoadSongEx Lib "fmod.dll" Alias "_FMUSIC_LoadSongEx@20" (ByVal name As String, ByVal memlength As Long, ByVal mode As FSOUND_MODES, ByRef sentencelist As Long, ByVal numitems As Long) As Long
Public Declare Function FMUSIC_LoadSongEx2 Lib "fmod.dll" Alias "_FMUSIC_LoadSongEx@20" (ByRef data As Byte, ByVal memlength As Long, ByVal mode As FSOUND_MODES, ByRef sentencelist As Long, ByVal numitems As Long) As Long
