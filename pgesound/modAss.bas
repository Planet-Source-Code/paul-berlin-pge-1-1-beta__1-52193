...
Public Const Reg_HKCR As Long = &H80000000
Public Const Reg_HKCU As Long = &H80000001
Public Const Reg_HKLM As Long = &H80000002
Public Const Reg_HKU  As Long = &H80000003
Public Const Reg_HKPD As Long = &H80000004
Public Const Reg_HKCC As Long = &H80000005
Public Const Reg_HKDD As Long = &H80000006
...
'REGISTRY ROUTINES
'-----------------
Function CreateKey(hKey As Long, subKey As String) As Long
...
Function OpenKey(hKey As Long, subKey As String) As Long
 On Error Resume Next
 Dim hReg As Long
...
Function GetDWord(hReg As Long, rValue As String) As Long
 On Error Resume Next
 Dim dwData As Long
...
Sub SetString(hKey As Long, rValue As String, strData As String)
 On Error Resume Next
...
Sub SetDWord(hReg As Long, rValue As String, dwData As Long)
 On Error Resume Next
...
Function GetString(hReg As Long, rValue As String) As String
 On Error Resume Next
